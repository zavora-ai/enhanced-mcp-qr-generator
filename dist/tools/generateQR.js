...
exports.generateQRWithUniqueFilename = exports.generateAndSaveQR = exports.saveQRToFile = exports.generateQR = void 0;
 ...
 */
async function generateQR(text, options = {}, config = config_1.defaultConfig) {
    try {
        // Validate input
        if (!text || text.trim() === '') {
 ...
 */
async function generatePngQR(text, options) {
    const qrOptions = {
        type: 'png',
 ...
 */
async function generateTerminalQR(text, options) {
    const qrOptions = {
        type: 'terminal',
        errorCorrectionLevel: options.errorCorrectionLevel,
        margin: options.margin,
 ...
 */
async function generateBase64QR(text, options) {
    const qrOptions = {
        type: 'utf8',
        errorCorrectionLevel: options.errorCorrectionLevel,
        margin: options.margin
 ...
 */
async function addLogoToQR(qrData, logo, format, config) {
    if (format === 'svg') {
 ...
 */
async function addLogoToSvg(svgData, logo) {
 ...
 */
async function addLogoToPng(pngData, logo, config) {
    // Extract base64 data
 ...
 * @returns Logo buffer
 */
async function fetchLogoFromUrl(url, config) {
    try {
        // Validate URL
 ...
 */
async function saveQRToFile(qrResult, outputPath) {
    try {
...
exports.saveQRToFile = saveQRToFile;
/**
 ...
 * @returns Path to saved file
 */
async function generateAndSaveQR(text, outputPath, options = {}, config = config_1.defaultConfig) {
    // Generate QR code
...
exports.generateQRWithUniqueFilename = generateQRWithUniqueFilename;
